    ...
    <div id="container">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-8">
                ...
                <button class="btn btn-danger" id="empDeleteAllModalBtn">删除</button>
            </div>
...
<script>
    ...
    function buildEmpsTable(result){
        ...
        $.each(emps, function (i, item) {
            ...
            var delBtn = '<button class="btn btn-danger btn-sm delete_btn" emp_id='+item.empId+'> <span  class="glyphicon glyphicon-trash" aria-hidden="true"></span> 删除 </button>';
    ...
    */
    ...
    $(document).on("click",".delete_btn",function(){
        console.log("找到点击元素的所有父类中叫tr的元素,然后找到第二个td,输出他的值__"+$(this).parents("tr").find("td:eq(1)").text());
    ...
    $('#checkAll').click(function () {
        ...
        // 我们这些原生的属性:
            // attr获取自定义属性,
            // prop获取是否选中
        console.log("是否全部选中_"+$(this).prop("checked"));
    ...
    $(document).on("click",".checkItem",function() {
        // 判断当前选中的元素是不是五个(全部)
        console.log("被选中的个数___"+$('.checkItem:checked').length);
        var flag = $('.checkItem:checked').length == $('.checkItem').length
        $('#checkAll').prop("checked",flag);
    });


    $('#empDeleteAllModalBtn').click(function () {
        $(".checkItem:checked")
        var empNames = "";
        var delIdStr = "";
        $.each($(".checkItem:checked"),function (i,v) {
            // $(this)相当于v,表示当前遍历的元素对象
            console.log("拿到所有选中行的名字__"+$(this).parents("tr").find("td:eq(2)").text());
